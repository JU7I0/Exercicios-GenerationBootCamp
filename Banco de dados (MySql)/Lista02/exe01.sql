...
insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) values ('ash','Recife',2000,1500,3);
insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) values ('xena','atenas',1000,1900,5);
insert into tb_personagens (nome,cidade,ataque,defesa,id_classe) values ('thor','argasd',3000,500,1);
